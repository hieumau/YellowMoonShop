...
<div class="product_image_area">
    <div class="container">
        <form method="post" action="MainController?btnAction=Create cake"
                ...
                <div class="">
                    ...
                    <div class="">
                        ...
                        <input id="datefield1" type="date" name="createDate" min="1975-01-01"
                               value="" placeholder="Expiry date" required>
                        <script>
                            var today = new Date();
                            ...
                            document.getElementById("datefield1").setAttribute("value", today);
                    ...
                    <div class="card_area d-flex align-items-center">
                        <button type="submit" class="genric-btn  primary-btn">Create</button>
                    </div>
                </div>
            </div>
